...
const DashboardPrtnerList = ({hendlerOpenListOfPartner}) => {
    ...
    return (
        <div className='admin_panel_items derection_wraper' >
            <div className='dashboard_partner_list_header'>
            <h3 className='dashboard_partner_list_title'>Partner</h3>
            <div className='dashboard_partner_list_three_dot_block'>
                <BsThreeDots 
                onClick={() => hendlerOpenListOfPartner()}
                className='dashboard_partner_list_three_dot_icon'/>
            </div>
            </div>
            <div className='derection_table_wrap'>
                ...
                <div className='table_body'>
                    {!!allUsersState.length && allUsersState.map((user) => (
